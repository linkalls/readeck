...
@freezed
class ExtractionProperties with _$ExtractionProperties {
  const factory ExtractionProperties({
    @JsonKey(name: 'json-ld') List<Map<String, dynamic>>? jsonLd, // List of JSON-LD objects
    List<Map<String, String>>? link, // List of link attribute maps (each map is key-value, e.g. {"@rel":"...", "@href":"..."})
    List<Map<String, String>>? meta, // List of meta attribute maps (each map is key-value)
...
@freezed
class ExtractionImageDetails with _$ExtractionImageDetails {
...
class ExtractionResult with _$ExtractionResult {
  const factory ExtractionResult({
    ...
    List<String>? logs,
    List<String>? errors,
    Map<String, List<String>>? meta, // "meta tags extracted", schema: {additionalProperties: {type: array, items: {type: string}}}
    ...
    Map<String, ExtractionImageDetails>? images, // additionalProperties for dynamic image keys
  }) = _ExtractionResult;
